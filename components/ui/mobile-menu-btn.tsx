...
export default function MenuLogo({ open, toggle }: MenuLogoProps) {
  return (
    <button
      ...
      className={cn(
        ...
        open ? "bg-zinc-100 dark:bg-zinc-900" : "bg-zinc-100 dark:bg-zinc-900"
      )}
    >
      <motion.svg
        width="100%"
        ...
        className={cn(
          "mt-1",
          open ? "stroke-accent dark:stroke-accent" : "stroke-accent"
        )}
